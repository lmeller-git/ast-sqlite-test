...
SELECT DISTINCT * FROM t0 WHERE NULL = t0.c0;
SELECT * FROM t0 WHERE (( (0 IS NOT FALSE) OR NOT (0 IS FALSE OR (t0.c0 = 1)) ) = 0);
SELECT ((0 IS NOT FALSE) OR NOT (0 IS FALSE OR (t0.c0 = 1)) ) = 0 FROM t0;
SELECT ( (0 IS NOT FALSE) OR NOT (0 = 0 OR (t0.c0 = 1)) ) = 0 FROM t0;
