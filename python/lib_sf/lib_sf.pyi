...
class RejectionReason:
    @staticmethod
    def invalid_syntax() -> RejectionReason: ...
    @staticmethod
...
class TestableEntry:
    ...
    def as_ast(self) -> list[Statement]: ...
    def to_sql_string(self) -> str: ...
    def fire_hooks(self, outcome: TestOutcome, data: engine.TestResult) -> None: ...
    @staticmethod
    def from_raw(raw: RawEntry) -> TestableEntry: ...
