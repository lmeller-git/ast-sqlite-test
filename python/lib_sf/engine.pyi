...
class StrategyBuilder:
    @staticmethod
    def random_uppercase(threshhold: float) -> StrategyBuilder: ...
    @staticmethod
    def merger() -> StrategyBuilder: ...
    @staticmethod
    def random_sampler(max_choices: int, choices: list[StrategyBuilder]) -> StrategyBuilder: ...
    @staticmethod
    def slice_in() -> StrategyBuilder: ...
    @staticmethod
...
class Engine:
    def __init__(
        self, scheduler: SchedulerBuilder, strategies: list[StrategyBuilder]
    ) -> None: ...
